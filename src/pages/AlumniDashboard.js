// frontend/src/pages/AlumniDashboard.js
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          {[
            ...
            { id: 'donate',    icon: '🎁', label: 'Make Donation' },
          ].map(tab => (
            <button key={tab.id}
                ...
                <tbody>
                  {donations.length === 0 ? (
                    ...
                    <tr key={d.donation_id}>
                      ...
                      <td className="amount">RM {parseFloat(d.amount).toFixed(2)}</td>
                ...
                <div className="quick-amounts">
                  {[10, 50, 100, 500].map(amt => (
                    <button type="button" key={amt}
                      className={`quick-btn ${donateForm.amount == amt ? 'active' : ''}`}
