...
async function startServer() {
  ...
  app.get("/api/admin/logs", authenticateToken, async (req: any, res: any) => {
    try {
      ...
      // Fetch logs, joining with Users table to get the email of who did it
